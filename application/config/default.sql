...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2017 at 09:09 PM
...
--
-- Database: `blog_badminton_cplusco`
--
...
CREATE TABLE IF NOT EXISTS `events` (
  ...
  `id_article` int(11) NOT NULL,
  `event_start` bigint(200) NOT NULL,
  `event_end` bigint(200) DEFAULT NULL,
...
--
ALTER TABLE `posts`
  MODIFY `id_post` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=58;
--
